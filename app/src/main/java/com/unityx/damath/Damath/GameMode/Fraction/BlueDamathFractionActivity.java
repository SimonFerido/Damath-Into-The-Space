...
import com.unityx.damath.Damath.GameMode.Polynomial.PinkDamathPolynomialActivity;
...
public class BlueDamathFractionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clickSound = MediaPlayer.create(BlueDamathFractionActivity.this, R.raw.click);
        ...
        tvPlayer2Name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(player2Enter == true && player2Left == false){
                    dialogBuilder = new AlertDialog.Builder(BlueDamathFractionActivity.this);
...
//row 8
        ...
        refThisRoom = refRoom.child("fraction").child("available").child(String.valueOf(room.getId()));
                            ...
                            if(dataSnapshot.getValue() != null) {
                                if (dataSnapshot.getValue(Room.class).getPlayer2() != null) {
                                    ...
                                    if(turn == true && (round%2 == 0)){
                                        Toast.makeText(BlueDamathFractionActivity.this, "Your Turn", Toast.LENGTH_SHORT).show();
                                    ...
                                    if (player2Enter == false){//first time enter
                                        ...
                                        if(player2Enter == true){
                                            ...
                                            new CountDownTimer(4000000,1000) {
                                                ...
                                                public void onFinish() {
                                                    if(counter == 0){
                                                        Toast.makeText(BlueDamathFractionActivity.this, "Game Ended", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            }.start();
                                        }
                                    ...
                                    if(checkWin() == true){
                                        player2Left = true;
                                        Toast.makeText(BlueDamathFractionActivity.this, "You win!", Toast.LENGTH_LONG).show();
                                        AlertDialog.Builder builder = new AlertDialog.Builder(BlueDamathFractionActivity.this);
                                        ...
                                        builder.setPositiveButton("Nice", new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                ...
                                                BlueDamathFractionActivity.super.onBackPressed();
                                                finish();
                                            }
                                        });
                                        builder.show();
                                    ...
                                    if(checkLose() == true){
                                        player2Left = true;
                                        Toast.makeText(BlueDamathFractionActivity.this, "You Lost!", Toast.LENGTH_LONG).show();
                                        AlertDialog.Builder builder = new AlertDialog.Builder(BlueDamathFractionActivity.this);
                                        builder.setTitle("Room Update");
                                    ...
                                    if (waitingMessage == false) {
                                        ...
                                        Toast.makeText(BlueDamathFractionActivity.this, "Waiting for another player", Toast.LENGTH_LONG).show();
                                        waitingMessage = true;
                                    } else {
                                        player2Left = true;
                                        Toast.makeText(BlueDamathFractionActivity.this, "User exited", Toast.LENGTH_LONG).show();
                                        AlertDialog.Builder builder = new AlertDialog.Builder(BlueDamathFractionActivity.this);
                                        tvPlayer2Name.setClickable(false);
                                        builder.setTitle("Room Update");
    ...
    private void onKillCalculator() {
        ...
        final Dialog calculatorDialog = new Dialog(BlueDamathFractionActivity.this);
