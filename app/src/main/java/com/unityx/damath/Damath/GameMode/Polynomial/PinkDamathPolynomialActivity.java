...
public class PinkDamathPolynomialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clickSound = MediaPlayer.create(PinkDamathPolynomialActivity.this, R.raw.click);
        ...
        tvPlayer2Name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(player1Exited == false){
                    dialogBuilder = new AlertDialog.Builder(PinkDamathPolynomialActivity.this);
...
//row 7
        ...
        refRoom.child("polynomial").child("unavailable").child(String.valueOf(room.getId())).setValue(room);
        refRoom.child("polynomial").child("available").child(String.valueOf(room.getId())).removeValue();
                            ...
                            if(dataSnapshot.getValue(Room.class) != null) {
                                if (dataSnapshot.getValue(Room.class).getPlayer1() != null) {
                                    ...
                                    if(turn == false && (round%2 != 0)){
                                        Toast.makeText(PinkDamathPolynomialActivity.this, "Your Turn", Toast.LENGTH_SHORT).show();
                                    ...
                                    new CountDownTimer(4000000,1000) {
                                        ...
                                        public void onFinish() {
                                            if(counter == 0){
                                                Toast.makeText(PinkDamathPolynomialActivity.this, "Game Ended", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    }.start();
                                    updateAllButtons();
                                    ...
                                    if(checkWin() == true){
                                        player1Exited =true;
                                        Toast.makeText(PinkDamathPolynomialActivity.this, "You win!", Toast.LENGTH_LONG).show();
                                        AlertDialog.Builder builder = new AlertDialog.Builder(PinkDamathPolynomialActivity.this);
                                        ...
                                        builder.setPositiveButton("Nice", new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                ...
                                                PinkDamathPolynomialActivity.super.onBackPressed();
                                                finish();
                                            }
                                        });
                                        builder.show();
                                    ...
                                    if(checkLose() == true){
                                        player1Exited =true;
                                        Toast.makeText(PinkDamathPolynomialActivity.this, "You Lost!", Toast.LENGTH_LONG).show();
                                        AlertDialog.Builder builder = new AlertDialog.Builder(PinkDamathPolynomialActivity.this);
                                        builder.setTitle("Room Update");
                                    ...
                                    Toast.makeText(PinkDamathPolynomialActivity.this, "User exited", Toast.LENGTH_LONG).show();
    ...
    private void onKillCalculator() {
        ...
        final Dialog calculatorDialog = new Dialog(PinkDamathPolynomialActivity.this);
