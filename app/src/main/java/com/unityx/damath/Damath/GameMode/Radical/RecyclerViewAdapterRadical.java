...
public class RecyclerViewAdapterRadical extends RecyclerView.Adapter<RecyclerViewAdapterRadical.ViewHolder>{
    ...
    public RecyclerViewAdapterRadical(Context context, ArrayList<Room>roomList){
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterRadical.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview, viewGroup, false);
        return new ViewHolder(view, context);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerViewAdapterRadical.ViewHolder viewHolder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(context, PinkDamathRadicalActivity.class);
