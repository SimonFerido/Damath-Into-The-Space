...
import com.unityx.damath.Damath.GameMode.Fraction.PinkDamathFractionActivity;
...
public class RecyclerViewAdapterFraction extends RecyclerView.Adapter<RecyclerViewAdapterFraction.ViewHolder>{
    ...
    public RecyclerViewAdapterFraction(Context context, ArrayList<Room>roomList){
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterFraction.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview, viewGroup, false);
        return new ViewHolder(view, context);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerViewAdapterFraction.ViewHolder viewHolder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(context, PinkDamathFractionActivity.class);
